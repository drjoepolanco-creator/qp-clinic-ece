  ...
  try {
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `Eres un médico experto en codificación CIE-10. Analiza la siguiente nota médica y propón los diagnósticos más probables.
...
Incluye entre 1 y 5 diagnósticos ordenados por probabilidad. El campo "certeza" debe ser: Principal, Secundario, o Diferencial.
